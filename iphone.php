    ...
    <div class="pbar">
     <div class="row">
       ...
       <div class="col-sm-1 ">
             ...
             <div class="picbar"> <img src="images/ipad.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/ipad.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/ipad.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/ipad.jpg"  class="img-responsive"></div>
        ...
        <div class="col-sm-5">
              ...
              <div class="bbar"><div class="pcbar"><img src="images/ipad.jpg" height="470px" class="img-responsive"></div></div>
       ...
       <div class="col-sm-6">
         	...
         	<div class="btnc"><b>Ipad Air</b></div><br><br>
         	<div style="font-size:20px;">Apple Inc</div><br>
         

         	<div style="font-size:20px;">$520.00</div><br><br>
          ...
          <input type="text" name="name" class="form-control" value="Ipad Air" readonly><br><br>
         	<p>External Memory</p>
...
<span style="font-size:10px">To create the astonishingly thin silhouette of iPad Air 2, we started by redesigning the Retina display, fusing what had been three layers into one. Not only did this make the display thinner, it made it better, with more vivid colors and greater contrast. Then we added an antireflective coating, giving iPad Air 2 one of the least reflective displays of any tablet in the world.</span></p>
         ...
         <div class="row">
          ...
          <span style="margin-left:10px"> <b>ACCESSORIES</b></span><br>
           	 <div class="col-sm-2">
           	 	...
           	 	<div class="acbar"><img src="images/6s.jpg" class="img-responsive"></div>
           	 		
           	 	
                
                <p align="center">iphone 4</p><br>
               <p align="center">$300.00</p>
               <a href="#"><div class="cart"><span class="glyphicon glyphicon-shopping-cart"></span></div></a>
           	 </div>
                
                <div class="col-sm-2">
           	 	       <div class="acbar"><img src="images/4s.jpg" class="img-responsive"></div>
           	 		
           	  <p align="center">iphone 4s</p><br>
