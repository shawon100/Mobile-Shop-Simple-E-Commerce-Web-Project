...
$sql="INSERT INTO cart VALUES('','$pname','$color','$size','$price','$username')";
...
<div class="row">
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
       ...
       <div class="col-sm-8">
       <center><span style="font-weight: bold;font-size: 30px;">My Cart</span></center><br><br>
    ...
    <?php
      ...
      {
          echo "<tr><td>$row[id]</td><td>$row[pname]</td><td>$row[color]</td><td>$row[size]</td><td>$row[price]</td>";
      }
    ...
    <div class="styler">
    	...
    	<div class="stylercon">
           ...
           <div class="stylermsg">
           <p style=" text-align:center;color:white">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut<br> enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
           </div>
    ...
    <div class="footercontent">
     <div class="row ">
         <div class="col-sm-4 im">
         	...
         	<div class="caption2">
              <b>Labore et dolore magna</b><br><br>
                <p style="font-size:15px;">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad.  </p>
                <p>
