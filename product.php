    ...
    <div class="pbar">
     <div class="row">
       ...
       <div class="col-sm-1 ">
             ...
             <div class="picbar"> <img src="images/d1.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/d1.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/d1.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/d1.jpg"  class="img-responsive"></div>
        ...
        <div class="col-sm-5">
              ...
              <div class="bbar"><div class="pcbar"><img src="images/d5.jpg" height="470px" class="img-responsive"></div></div>
       ...
       <div class="col-sm-6">
         	...
         	<div class="btnc"><b>Galaxy Note</b></div><br><br>
         	<div style="font-size:20px;">Samsung Phone</div><br>
         	<!--<div class="cbar">Condition</div>
         	<div class="btnc"><b>New Product</b></div> <b>100</b> ITEMS<br><br>-->
          ...
          <input type="text" name="name" class="form-control" value="Galaxy Note" readonly><br><br>
         	<p>External Memory</p>
          ...
          <input type="text" name="price" class="form-control" value="$520.00" readonly><br><br>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
          	...
          	<ul class="nav nav-tabs nav-stacked">
          	  <li class="active"><a data-toggle="tab" href="#minfo">More Info</a></li>
          	   <li><a data-toggle="tab" href="#ds">Features</a></li>
          	    <li><a data-toggle="tab" href="#down">Download</a></li>
          	      <li><a data-toggle="tab" href="#vc">Video</a></li>
          	  </ul>
          	  ...
          	  <br> <p>lternate names  Galaxy Note</p>
<p>Release date  April 2014</p>
<p>Form factor Touchscreen</p>
<p>Dimensions (mm) 142.00 x 72.50 x 8.10</p>
<p>Weight (g)  145.00</p>
<p>Battery capacity (mAh)  2800</p>
<p>Removable battery Yes</p>
<p>Colours White, Black</p>
<p>SAR value NA<p>
          	  ...
          	  <div id="vc" class="tab-pane fade">
                 ...
                 <iframe width="560" height="315" src="https://www.youtube.com/watch?v=UtbVltBueBk" frameborder="0" allowfullscreen></iframe>
...
<span style="font-size:10px">The powerful and professional Samsung Galaxy S5 offers a 5.1” Full HD display for enhanced viewing as well as dust and water resistance.</span></p>
          ...
          <span style="margin-left:10px"> <b>ACCESSORIES</b></span><br>
               ...
               <a href="#"><div class="cart"><span class="glyphicon glyphicon-shopping-cart"></span></div></a>
                ...
                <div class="col-sm-2">
           	  ...
           	  <p align="center">Galaxy S3</p><br>
               <p align="center">$202.00</p>
               ...
               <p align="center">Galaxy S4</p><br>
               <p align="center">$402.00</p>
              ...
              <p align="center">Galaxy Y</p><br>
               <p align="center">$222.00</p>
               <a href="#"><div class="cart"><span class="glyphicon glyphicon-shopping-cart"></span></div></a>
           	 </div>
