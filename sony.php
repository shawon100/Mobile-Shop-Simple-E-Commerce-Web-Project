    ...
    <div class="pbar">
     <div class="row">
       ...
       <div class="col-sm-1 ">
             ...
             <div class="picbar"> <img src="images/soc.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/soc.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/soc.jpg"  class="img-responsive"></div>
             <div class="picbar"> <img src="images/soc.jpg"  class="img-responsive"></div>
        ...
        <div class="col-sm-5">
              ...
              <div class="bbar"><div class="pcbar"><img src="images/soc.jpg" height="470px" class="img-responsive"></div></div>
       ...
       <div class="col-sm-6">
         	...
         	<div class="btnc"><b>Sony C</b></div><br><br>
         	<div style="font-size:20px;">Sony</div><br>
         

         	<div style="font-size:20px;">$320.00</div><br><br>
          ...
          <input type="text" name="name" class="form-control" value="Sony" readonly><br><br>
         	<p>External Memory</p>
          	  ...
          	  <li class="active"><a data-toggle="tab" href="#minfo">More Info</a></li>
          	   <li><a data-toggle="tab" href="#ds">Features</a></li>
          	    <li><a data-toggle="tab" href="#down">Download</a></li>
          	      <li><a data-toggle="tab" href="#vz">Video</a></li>
          	  </ul>
...
PICTURES</p>
   ...
   <input type="file" name="image">
          	  ...
          	  <div id="vz" class="tab-pane fade">
          	  	

                <iframe width="560" height="315" src="https://www.youtube.com/watch?v=_txZu0FzwTA" frameborder="0" allowfullscreen></iframe>
...
<span style="font-size:10px">The power to capture every moment

    Triple image sensing technology
    Polished metal back
    Smart battery management</span></p>
         ...
         <div class="row">
          ...
          <span style="margin-left:10px"> <b>ACCESSORIES</b></span><br>
           	 <div class="col-sm-2">
           	 	...
           	 	<div class="acbar"><img src="images/sod.jpg" class="img-responsive"></div>
           	 		
           	 	
                
                <p align="center">Sony D</p><br>
